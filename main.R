...
datastory_name <- "ambizione_grantees_career_boost"
...
# characters etc.)
# -> Don't put "datastory" at the start or end!
datastory_name_en <- "ambizione-grantees-career-boost"
datastory_name_de <- "ambizione-karriereschub-fuer-gefoerderte-forschende"
datastory_name_fr <- "stimulation-de-carriere-pour-les-beneficiaires-ambizione"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "Ambizione: Funded researchers recognise boost for their careers"
lead_en <- "The SNSF has been monitoring the impact of Ambizione grants on researchers’ careers via yearly surveys. Grantees highly value the positive effects on their scientific profile and recognise a career boost."
# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Ambizione: Karriereschub für geförderte Forschende"
lead_de <- "Der SNF evaluiert jährlich den Nutzen der Ambizione-Beiträge für die Laufbahn der Forschenden. Die Beitragsempfangenden schätzen die Wirkung auf ihr wissenschaftliches Profil sehr positiv ein und berichten von einem Karriereschub."
# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "Ambizione : les scientifiques soutenus ont vu leur carrière s’accélérer"
lead_fr <- "Le FNS mène des enquêtes annuelles pour analyser l’effet des subsides Ambizione sur ses bénéficiaires. Selon les sondé·es, Ambizione a une influence positive sur leur profil scientifique et un effet dynamisant sur leur carrière."
# Contact persons, always (first name + last name)
contact_person <- c("Brian Gertsch", "Jonathan Wust")
...
publication_date <- "2023-12-14 04:00:00"
...
doi_url <- "https://doi.org/10.46446/datastory.ambizione-grantees-career-boost"
